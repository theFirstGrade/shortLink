...
import org.zhenhaochen.shortlink.admin.config.UserFlowRiskControlConfiguration;

import java.io.IOException;
import java.io.PrintWriter;
import java.util.Optional;

import static org.zhenhaochen.shortlink.admin.common.convention.errorcode.BaseErrorCode.FLOW_LIMIT_ERROR;

/**
 * Traffic Risk Control Filter
 */
@Slf4j
...
public class UserFlowRiskControlFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            log.error("traffic risk control LUA script failed", ex);
